...
export const MARKET_PRESETS: MarketPreset[] = [
  // Movement
  {
    ...
    category: 'movement',
    query: { sortBy: 'percent_change_24h', sortDir: 'desc', changeFilter: 'gainers', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'movement',
    query: { sortBy: 'percent_change_24h', sortDir: 'asc', changeFilter: 'losers', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'movement',
    query: { sortBy: 'volume_24h', sortDir: 'desc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'movement',
    query: { sortBy: 'percent_change_24h', sortDir: 'desc', changeFilter: 'gainers', categoryFilter: 'all', minVolume: 10000000, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  // Network
  {
    ...
    category: 'network',
    query: { sortBy: 'market_cap_rank', sortDir: 'asc', changeFilter: 'all', categoryFilter: 'layer-1', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'network',
    query: { sortBy: 'percent_change_24h', sortDir: 'desc', changeFilter: 'gainers', categoryFilter: 'layer-1', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  // Structure
  {
    ...
    category: 'structure',
    query: { sortBy: 'market_cap_rank', sortDir: 'asc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'structure',
    query: { sortBy: 'market_cap_rank', sortDir: 'asc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 100 },
  ...
  // Sentiment
  {
    ...
    category: 'sentiment',
    query: { sortBy: 'galaxy_score', sortDir: 'desc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'sentiment',
    query: { sortBy: 'social_volume', sortDir: 'desc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
  ...
  },
  {
    ...
    category: 'sentiment',
    query: { sortBy: 'sentiment', sortDir: 'desc', changeFilter: 'all', categoryFilter: 'all', minVolume: 0, minGalaxyScore: 0, minMarketCap: 5000, limit: 25 },
