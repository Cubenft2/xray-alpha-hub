...
export function XRTicker({ type, symbols }: XRTickerProps) {
  ...
  const defaultSymbols = {
    crypto: 'COINBASE:BTCUSD,COINBASE:ETHUSD,BINANCE:BTCUSDT,BINANCE:ETHUSDT,BINANCE:BNBUSDT,BINANCE:SOLUSDT,BINANCE:XRPUSDT,BINANCE:ADAUSDT,BINANCE:AVAXUSDT,BINANCE:DOGEUSDT,BINANCE:SHIBUSDT,BINANCE:LINKUSDT,BINANCE:DOTUSDT,BINANCE:UNIUSDT,BINANCE:MATICUSDT,BINANCE:LTCUSDT,BINANCE:BCHUSDT,BINANCE:ATOMUSDT,BINANCE:FILUSDT,BINANCE:XLMUSDT,BINANCE:ALGOUSDT,BINANCE:MANAUSDT,BINANCE:SANDUSDT,BINANCE:CHZUSDT,BINANCE:NEARUSDT,BINANCE:AXSUSDT,BINANCE:COMPUSDT,BINANCE:MKRUSDT,BINANCE:AAVEUSDT,BINANCE:SNXUSDT,BINANCE:YFIUSDT,BINANCE:CRVUSDT,BINANCE:ENJUSDT,BINANCE:GALAUSDT,BINANCE:FLOWUSDT,BINANCE:ICPUSDT,BINANCE:FETUSDT,BINANCE:PEPEUSDT,BINANCE:1000BONKUSDT,BINANCE:WIFUSDT,BINANCE:ARBUSDT,BINANCE:RNDRUSDT,BINANCE:TONUSDT,BINANCE:TRXUSDT,BINANCE:ZETAUSDT,BINANCE:SUIUSDT,BINANCE:CETUSUSDT,BINANCE:FDUSD,BINANCE:HYPEUSDT,OKX:OKBUSDT',
