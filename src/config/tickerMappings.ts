...
export const CRYPTO_TICKERS: Record<string, TickerMapping> = {
  ...
  'WAL': { symbol: 'KUCOIN:WALUSDT', displayName: 'Walrus (WAL)', type: 'crypto' },
  'WALRUS': { symbol: 'KUCOIN:WALUSDT', displayName: 'Walrus (WAL)', type: 'crypto' },
  'WALUSDT': { symbol: 'KUCOIN:WALUSDT', displayName: 'Walrus (WAL)', type: 'crypto' },
  'USELESS': { symbol: 'CRYPTO:USELESSUSD', displayName: 'Useless Coin (USELESS)', type: 'crypto' },
  'USELESS COIN': { symbol: 'CRYPTO:USELESSUSD', displayName: 'Useless Coin (USELESS)', type: 'crypto' },
  'USELESSCOIN': { symbol: 'CRYPTO:USELESSUSD', displayName: 'Useless Coin (USELESS)', type: 'crypto' },
  'USELESSUSDT': { symbol: 'CRYPTO:USELESSUSD', displayName: 'Useless Coin (USELESS)', type: 'crypto' },
